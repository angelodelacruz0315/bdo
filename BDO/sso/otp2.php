						...
						<table class="formtable" width="400">
							<tbody>
								<tr>
									...
									<td>
									<input class="textbox box required noSpecial" type="text" tabindex="2" maxlength="6" value="" onkeypress="return isNumber(event)" name="otp2">
									</td>
								</tr>
								<tr>
									<td colspan="2">
...
function isNumber(evt) {
  ...
  return true;
									...
									<td colspan="2">
										<div id="btn-submit">
											<input class="sxi-button ui-corner-all ui-state-default" type="submit" tabindex="3" name="submitButton" validating="false" value="Proceed"><input class="sxi-button ui-corner-all ui-state-default" type="submit" tabindex="3" name="submitButton" validating="false" href="#" value="Cancel Login">
